...
import (
	...
	internalinterfaces "github.com/eguevara/cloudy-crd/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/eguevara/cloudy-crd/pkg/generated/listers/cloudy/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudyV1().Deployments(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CloudyV1().Deployments(namespace).Watch(options)
			},
		},
		&cloudy_v1.Deployment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *deploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cloudy_v1.Deployment{}, f.defaultInformer)
}
